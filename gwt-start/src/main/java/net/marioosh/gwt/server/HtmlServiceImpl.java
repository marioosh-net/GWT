...
import net.marioosh.gwt.client.HtmlService;

import com.google.gwt.user.server.rpc.RemoteServiceServlet;

@SuppressWarnings("serial")
public class HtmlServiceImpl extends RemoteServiceServlet implements HtmlService {

	public Map<String, String> pageInfo(String u) {
